        ...
        <Blockquote mt="xl" icon={<IconBook />}>
          ...
          <Timeline active={2} bulletSize={24} lineWidth={2}>
            ...
            >
              ...
              <List size="sm">
                <List.Item>
                  ...
                  design specifications. Identify and address any code issues
                  related to UI/UX, performance, and responsiveness.
                </List.Item>
                <List.Item>
                  Develop and execute comprehensive test plans for front-end
                  components, including functional, regression, and integration
                  testing. Implement and maintain automated testing processes
                  for front-end code using testing frameworks and tools.
                </List.Item>
                <List.Item>
                  Ensure the compatibility of front-end code across various
                  browsers and devices, addressing any inconsistencies or issues
                  that may arise. Conduct responsive design testing to guarantee
                  a consistent user experience on different screen sizes.
                </List.Item>
                <List.Item>
                  Collaborate with front-end developers to identify and address
                  performance bottlenecks in the user interface. Implement
                  optimization strategies to enhance the speed and efficiency of
                  web applications.
                </List.Item>
                <List.Item>
                  Verify and enforce adherence to web accessibility standards
                  (e.g., WCAG) to ensure that web applications are usable by
                  individuals with disabilities. Conduct accessibility testing
                  and collaborate with developers to make necessary adjustments.
                </List.Item>
                <List.Item>
                  Utilize issue tracking systems to log and monitor defects,
                  ensuring that identified issues are addressed promptly.
                  Generate and maintain detailed reports on testing progress,
                  results, and any identified issues.
                </List.Item>
                <List.Item>
                  Work closely with front-end developers and other team members
                  to understand design specifications and functional
                  requirements. Participate in agile or other development
                  methodologies to integrate QA processes seamlessly into the
                  development lifecycle.
                </List.Item>
                <List.Item>
                  Stay updated on industry trends, emerging technologies, and
                  best practices in front-end development and quality assurance.
                  Implement continuous improvement initiatives to enhance the
                  efficiency and effectiveness of QA processes.
                </List.Item>
                <List.Item>
                  Create and maintain documentation for testing processes, test
                  cases, and quality assurance standards.
                </List.Item>
                <List.Item>
                  Provide clear and detailed documentation on identified issues,
                  testing results, and resolution steps.
                </List.Item>
                <List.Item>
                  Evaluate the overall user experience and provide feedback to
                  improve the design and usability of front-end interfaces.
                </List.Item>
                <List.Item>
                  Collaborate with UX/UI designers to ensure the alignment of
                  visual and interactive elements with design guidelines.
                </List.Item>
              </List>
            </Timeline.Item>
            <Timeline.Item
            ...
            >
              ...
              <List size="sm">
                <List.Item>
                  Designing and implementing visually appealing and userfriendly
                  interfaces using Angular best practices.
                </List.Item>
                <List.Item>
                  Writing clean, maintainable, and reusable code that follows
                  web standards and adheres to Angular coding conventions.
                </List.Item>
                <List.Item>
                  Developing product features and functionalities using Angular
                  components, services, directives, pipes, and modules.
                </List.Item>
                <List.Item>
                  Integrating data from various back-end services and databases
                  using REST APIs and HTTP requests.
                </List.Item>
                <List.Item>
                  Debugging and troubleshooting issues across multiple browsers
                  and devices.
                </List.Item>
                <List.Item>
                  Working with version control tools such as Git and
                  collaborating with other developers using agile methodologies.
                </List.Item>
                <List.Item>
                  Keeping up to date with the latest trends and technologies in
                  web development and Angular ecosystem.
                </List.Item>
              </List>
            </Timeline.Item>
            <Timeline.Item
            ...
            >
              ...
              <List size="sm">
                ...
                <List.Item>
                  Answers inquiries about the University by phone, in person,
                  and by email; responds to problems and needs.
                </List.Item>
              </List>
            </Timeline.Item>
          </Timeline>
